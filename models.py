...
class CrossingTimes(db.Model):
    ...
    to_date = Column(Text)
    safeFrom1 = Column('safeFrom1', Text)
    safeTo1 = Column('safeTo1', Text)
    safeFrom2 = Column('safeFrom2', Text)
    safeTo2 = Column('safeTo2', Text)
    unsafeFrom1 = Column('unsafeFrom1', Text)
    unsafeTo1 = Column('unsafeTo1', Text)
    unsafeFrom2 = Column('unsafeFrom2', Text)
    unsafeTo2 = Column('unsafeTo2', Text)
    status = Column(Text, nullable=False, default='active')
    notes = Column(Text)
    createdAt = Column('createdAt', TIMESTAMP, default=func.now())
    updatedAt = Column('updatedAt', TIMESTAMP, default=func.now(), onupdate=func.now())
